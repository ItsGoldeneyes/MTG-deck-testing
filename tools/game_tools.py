...
def run_game(deck1_name, deck2_name, deck3_name=None, deck4_name=None, game_count=1, working_dir=None, format='jumpstart', quiet=True):
    """
    ...
    Args:
        ...
        quiet (bool): Whether to run in quiet mode (suppress output)
